...
export const ALL_GUIDES: Guide[] = [
  ...
  { slug: 'fill-and-sand-a-wall', title: 'Fill and sand a wall', time: '45 mins', cost: '£5–10', level: 'Beginner', category: 'Decorating', href: '/guides/fill-and-sand-a-wall', difficulty: 2, saves: 'Save £50–100 today', skillPoints: 20 },
  { slug: 'tile-a-splashback', title: 'Tile a splashback', time: 'Half a day', cost: '£30–80', level: 'Intermediate', category: 'Decorating', href: '/guides/tile-a-splashback', difficulty: 3, saves: 'Save £150–300 today', skillPoints: 30 },
  { slug: 'strip-wallpaper', title: 'Strip wallpaper', time: 'Half a day', cost: '£12–25', level: 'Beginner', category: 'Decorating', href: '/guides/strip-wallpaper', difficulty: 2, saves: 'Save £100–200 today', skillPoints: 20 },
  { slug: 'repair-a-ceiling-crack', title: 'Repair a crack in a ceiling', time: '1 hour', cost: '£6–22', level: 'Beginner', category: 'Decorating', href: '/guides/repair-a-ceiling-crack', difficulty: 2, saves: 'Save £80–150 today', skillPoints: 20 },
  { slug: 'boiler-breakdown', title: 'What to do if your boiler breaks down', time: '30 mins', cost: 'Free', level: 'Beginner', category: 'Heating', href: '/guides/boiler-breakdown', difficulty: 1, saves: 'Save £100–300 today', ukSpecific: true, skillPoints: 10 },
  { slug: 'turn-off-electricity-fuse-box', title: 'Turn off your electricity at the fuse box', time: '5 mins', cost: 'Free', level: 'Beginner', category: 'Electrics', href: '/guides/turn-off-electricity-fuse-box', difficulty: 1, saves: 'Essential safety knowledge', quickWin: true, skillPoints: 10 },
  { slug: 'read-your-energy-meter', title: 'Read your energy meter', time: '5 mins', cost: 'Free', level: 'Beginner', category: 'General', href: '/guides/read-your-energy-meter', difficulty: 1, saves: 'Prevents overcharging', ukSpecific: true, quickWin: true, skillPoints: 10 },
  { slug: 'draft-proof-door-window', title: 'Draft proof a door or window', time: '30 mins', cost: '£8–20', level: 'Beginner', category: 'General', href: '/guides/draft-proof-door-window', difficulty: 1, saves: 'Save £50–150 per year', ukSpecific: true, skillPoints: 10 },
  { slug: 'replace-a-smoke-alarm-battery', title: 'Replace a smoke alarm battery', time: '5 mins', cost: '£3–5', level: 'Beginner', category: 'Electrics', href: '/guides/replace-a-smoke-alarm-battery', difficulty: 1, saves: 'Keeps your home protected', quickWin: true, skillPoints: 10 },
  { slug: 'install-a-smart-thermostat', title: 'Install a smart thermostat', time: '1–2 hours', cost: '£100–250', level: 'Intermediate', category: 'Electrics', href: '/guides/install-a-smart-thermostat', difficulty: 3, saves: 'Save £150–300/year', ukSpecific: true, skillPoints: 30 },
  { slug: 'bleed-all-radiators', title: 'Bleed all radiators', time: '1 hour', cost: '£1–3', level: 'Beginner', category: 'Heating', href: '/guides/bleed-all-radiators', difficulty: 1, saves: 'Save £80–150 today', ukSpecific: true, skillPoints: 10 },
  { slug: 'fix-a-noisy-radiator', title: 'Fix a noisy radiator', time: '30 mins', cost: 'Free–£5', level: 'Beginner', category: 'Heating', href: '/guides/fix-a-noisy-radiator', difficulty: 1, saves: 'Save £50–80 today', ukSpecific: true, skillPoints: 10 },
  { slug: 'boiler-breakdown-what-to-do', title: 'Boiler breakdown: what to do', time: '30 mins', cost: 'Free', level: 'Beginner', category: 'Heating', href: '/guides/boiler-breakdown-what-to-do', difficulty: 1, saves: 'Save £100–300 today', ukSpecific: true, skillPoints: 10 },
  { slug: 'fix-a-garden-tap', title: 'Fix a leaking garden tap', time: '30 mins', cost: '£3–10', level: 'Beginner', category: 'Outdoor', href: '/guides/fix-a-garden-tap', difficulty: 1, saves: 'Save £60–100 today', ukSpecific: true, skillPoints: 10 },
  { slug: 'unblock-a-gutter', title: 'Unblock a gutter', time: '1 hour', cost: '£15–30', level: 'Beginner', category: 'Outdoor', href: '/guides/unblock-a-gutter', difficulty: 1, saves: 'Save £80–150 today', skillPoints: 10 },
  { slug: 'fix-a-fence-panel', title: 'Fix a fence panel', time: '2 hours', cost: '£30–80', level: 'Beginner', category: 'Outdoor', href: '/guides/fix-a-fence-panel', difficulty: 2, saves: 'Save £100–200 today', skillPoints: 20 },
  { slug: 'lay-decking-boards', title: 'Lay decking boards', time: 'Full day', cost: '£200–600', level: 'Intermediate', category: 'Outdoor', href: '/guides/lay-decking-boards', difficulty: 3, saves: 'Save £500–1,500 today', skillPoints: 30 },
]
