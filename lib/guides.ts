...
export const ALL_GUIDES: Guide[] = [
  ...
  {
    slug: 'fix-a-light-that-wont-turn-on', title: 'Fix a light that won\'t turn on',
    time: '15 mins', timeMinutes: 15, cost: '£0–8', level: 'Beginner', category: 'Electrics',
    href: '/guides/fix-a-light-that-wont-turn-on', difficulty: 1,
    saves: 'Save £40–80 today', estimatedSavingsMin: 40, estimatedSavingsMax: 80,
    emoji: '💡', ukSpecific: false, quickWin: true, skillPoints: 10, popularityScore: 68,
    searchTerms: ['light not working', 'light won\'t turn on', 'light stopped working', 'light not coming on', 'ceiling light not working', 'lamp not working', 'light switch not working', 'fix a light'],
    description: 'A light that won\'t turn on is almost always a dead bulb, a tripped breaker, or a loose connection. Work through the causes in order and you will find it in minutes.',
  },
  {
    slug: 'fix-peeling-paint', title: 'Fix peeling paint on a wall',
    time: '2–3 hours', timeMinutes: 150, cost: '£15–55', level: 'Beginner', category: 'Decorating',
    href: '/guides/fix-peeling-paint', difficulty: 2,
    saves: 'Save £60–120 today', estimatedSavingsMin: 60, estimatedSavingsMax: 120,
    emoji: '🖌️', ukSpecific: false, quickWin: false, skillPoints: 20, popularityScore: 62,
    searchTerms: ['peeling paint', 'flaking paint', 'paint peeling off wall', 'paint peeling', 'fix peeling paint', 'paint coming off wall', 'bubbling paint', 'paint not sticking'],
    description: 'Fix peeling paint so it does not come back. The key is preparation — remove all loose paint, prime the bare surface, then repaint.',
  },
  {
    slug: 'fix-a-leaking-pipe-under-sink', title: 'Fix a leaking pipe under a sink',
    time: '30 mins', timeMinutes: 30, cost: '£0–20', level: 'Beginner', category: 'Plumbing',
    href: '/guides/fix-a-leaking-pipe-under-sink', difficulty: 2,
    saves: 'Save £60–120 today', estimatedSavingsMin: 60, estimatedSavingsMax: 120,
    emoji: '💧', ukSpecific: true, quickWin: false, skillPoints: 15, popularityScore: 65,
    searchTerms: ['leaking pipe under sink', 'dripping under sink', 'sink pipe leak', 'pipe under kitchen sink', 'basin pipe dripping', 'bottle trap leak', 'waste pipe leak under sink', 'fix under sink pipe'],
    description: 'A drip under the sink is almost always a loose fitting or a failed rubber seal. Fix it yourself in 30 minutes — no tools required for most repairs.',
  },
  {
    slug: 'unblock-a-sink', title: 'Unblock a sink without chemicals',
    time: '15–30 mins', timeMinutes: 22, cost: '£0–12', level: 'Beginner', category: 'Plumbing',
    href: '/guides/unblock-a-sink', difficulty: 1,
    saves: 'Save £60–100 today', estimatedSavingsMin: 60, estimatedSavingsMax: 100,
    emoji: '🪣', ukSpecific: false, quickWin: true, skillPoints: 10, popularityScore: 72,
    searchTerms: ['unblock sink', 'blocked sink', 'sink blocked', 'slow draining sink', 'sink not draining', 'unblock kitchen sink', 'unblock bathroom sink', 'sink drain blocked', 'how to unblock a sink without chemicals'],
    description: 'A blocked sink is almost always grease or hair in the trap. Fix it yourself in 15–30 minutes — four methods from easiest to most thorough, no chemicals needed.',
  },
  {
    slug: 'fix-a-loose-door-handle', title: 'Fix a loose door handle',
    time: '15 mins', timeMinutes: 15, cost: '£0–8', level: 'Beginner', category: 'Carpentry',
    href: '/guides/fix-a-loose-door-handle', difficulty: 1,
    saves: 'Save £40–80 today', estimatedSavingsMin: 40, estimatedSavingsMax: 80,
    emoji: '🚪', ukSpecific: false, quickWin: true, skillPoints: 10, popularityScore: 58,
    searchTerms: ['loose door handle', 'wobbly door handle', 'door handle loose', 'fix door handle', 'door handle falling off', 'door handle grub screw', 'door handle spindle', 'tighten door handle'],
    description: 'A wobbly door handle is almost always a loose grub screw or stripped fixing. Tighten it in 15 minutes — no handyman needed.',
  },
  {
