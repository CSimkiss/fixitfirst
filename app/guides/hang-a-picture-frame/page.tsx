  ...
  return (
    <main className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <p className="text-gray-500 mb-6">20 mins · Beginner · Saves £30–60 vs a handyperson</p>
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-gray-700 mb-2">Always use a cable and pipe detector before drilling. Cables run vertically from sockets and switches; pipes run to radiators and bathrooms.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3 text-sm">
              ...
              <span><span className="font-medium">Wall fixings</span> — <span className="text-orange-600">buy: buy: £2–5 — picture hooks for light frames; wall plugs and screws for heavier ones</span></span>
            </li>
          </ul>
        </div>
