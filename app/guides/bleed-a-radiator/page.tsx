  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <p className="text-gray-500 mb-8">15 mins · Beginner · Saves £50-80 vs a heating engineer</p>
        ...
        <div className="mb-6">
          ...
          <div className="space-y-4">
            <div className="flex gap-4"><div className="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center font-bold shrink-0">1</div><div><h3 className="font-semibold mb-1">Turn off the heating</h3><p className="text-sm text-gray-600">Switch off your central heating and wait 20–30 minutes for the radiators to cool. Never bleed a hot radiator.</p></div></div>
            <div className="flex gap-4"><div className="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center font-bold shrink-0">2</div><div><h3 className="font-semibold mb-1">Locate the bleed valve</h3><p className="text-sm text-gray-600">Find the small square valve at the top corner of the radiator. Place a cloth underneath to catch any water.</p></div></div>
            <div className="flex gap-4"><div className="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center font-bold shrink-0">3</div><div><h3 className="font-semibold mb-1">Insert the bleed key</h3><p className="text-sm text-gray-600">Fit the bleed key into the square slot on the valve. Turn it slowly anticlockwise — about a quarter turn.</p></div></div>
            <div className="flex gap-4"><div className="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center font-bold shrink-0">4</div><div><h3 className="font-semibold mb-1">Let the air escape</h3><p className="text-sm text-gray-600">You will hear a hissing sound as air escapes. Keep the key in place and wait until the hissing stops and water starts to trickle out.</p></div></div>
            <div className="flex gap-4"><div className="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center font-bold shrink-0">5</div><div><h3 className="font-semibold mb-1">Tighten the valve</h3><p className="text-sm text-gray-600">As soon as water appears, turn the key clockwise to close the valve. Do not overtighten.</p></div></div>
            <div className="flex gap-4"><div className="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center font-bold shrink-0">6</div><div><h3 className="font-semibold mb-1">Check boiler pressure and test</h3><p className="text-sm text-gray-600">Check your boiler pressure gauge — it should read 1–1.5 bar. If it has dropped, top it up using the filling loop. Turn the heating back on and check the radiator heats evenly.</p></div></div>
          </div>
        </div>
