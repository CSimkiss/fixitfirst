    ...
    <main className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-gray-700 mb-2">This is a safe, straightforward job on any sealed central heating system (the most common type in UK homes). It takes 10 minutes.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3 text-sm">
              ...
              <span><span className="font-medium">No tools needed</span> — everything required is already on your boiler</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-blue-900">You can now bleed radiators, identify pressure loss patterns, and have an informed conversation with a heating engineer about any persistent issues.</p>
        </div>
