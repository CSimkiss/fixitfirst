    ...
    <main className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-gray-700 mb-2">The stop cock is almost always under the kitchen sink in UK homes. Take 5 minutes now to find it, before you ever need it.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3 text-sm">
              ...
              <span><span className="font-medium">Flat-head screwdriver</span> — <span className="text-orange-600">buy: some older stop cocks require a screwdriver in the slot — buy: already in most homes</span></span>
            </li>
            <li className="flex items-start gap-3 text-sm">
              <span className="text-orange-500 font-bold mt-0.5 shrink-0">!</span>
              <span><span className="font-medium">Stop cock key</span> — <span className="text-orange-600">buy: buy: £3–5 from a plumber's merchant — useful if the stop cock is stiff or in a pit outside</span></span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-blue-900">With confidence in turning off the mains, you can safely tackle any plumbing job: fixing leaks, replacing taps, installing washing machines, and more.</p>
        </div>
