  ...
  return (
    <main className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <p className="text-4xl font-black text-green-600 mb-1">Save £80–150 in 45 mins — no plumber needed</p>
...
<PrintButton />
    ...
    { icon: 'buy', name: 'PTFE tape', hint: 'buy from any hardware shop', hintOrange: true },
        ...
        <RenovationContinue
          currentSlug="fix-a-dripping-tap"
          relatedSlugs={['fix-a-running-toilet', 'prep-bathroom-plumbing', 'tile-a-splashback']}
        />
        <GuideActions slug="fix-a-dripping-tap">
