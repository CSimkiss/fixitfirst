    ...
    <main className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-gray-700 mb-2">Most holes and cracks in a wall are caused by nails, screws, minor impacts, or normal shrinkage. All of them can be fixed with the same basic technique.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3 text-sm">
              ...
              <span><span className="font-medium">Ready-mixed filler</span> — <span className="text-orange-600">buy: buy: £3–5 — Polyfilla or own-brand equivalent from any hardware shop</span></span>
            </li>
            <li className="flex items-start gap-3 text-sm">
              <span className="text-orange-500 font-bold mt-0.5 shrink-0">!</span>
              <span><span className="font-medium">Sandpaper 120-grit and 240-grit</span> — <span className="text-orange-600">buy: buy: £2–4 — coarse to shape, fine to finish</span></span>
            </li>
            <li className="flex items-start gap-3 text-sm">
              <span className="text-orange-500 font-bold mt-0.5 shrink-0">!</span>
              <span><span className="font-medium">Primer or mist coat</span> — <span className="text-orange-600">buy: buy: £3–8 — needed over bare filler before painting</span></span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-blue-900">Once you can fill and sand, you are ready to paint a room properly — or tackle larger repairs like patching a hole bigger than 20mm.</p>
        </div>
