    ...
    <main className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-gray-700 mb-2">Your consumer unit is usually under the stairs, in a hallway cupboard, or in the kitchen. It is a grey or white box with rows of switches inside.</p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-blue-900">With confidence at the consumer unit, you can now safely replace light switches, change sockets, and do any electrical work — knowing you can fully isolate the circuit first.</p>
        </div>
