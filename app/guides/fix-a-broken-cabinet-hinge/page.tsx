    ...
    <main className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-gray-700 mb-2">Before buying a new hinge, try the adjustment screws. Most drooping or misaligned cabinet doors just need a small tweak with a cross-head screwdriver — no new parts required.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3 text-sm">
              ...
              <span><span className="font-medium">Replacement hinge</span> — <span className="text-orange-600">buy: buy: £2–5 — take the old hinge to match the cup diameter, usually 35mm, and the arm length</span></span>
            </li>
          </ul>
        </div>
