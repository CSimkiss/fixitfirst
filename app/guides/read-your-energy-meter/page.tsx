  ...
  return (
    <main className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <ToolsSection
          tools={[
    { icon: 'check', name: 'Nothing needed', hint: 'just your meter and phone to submit the reading' },
  ]}
          slug="read-your-energy-meter"
          guideName="Read your energy meter"
        />
        ...
        <GuideActions slug="read-your-energy-meter">
