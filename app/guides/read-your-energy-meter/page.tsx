  ...
  return (
    <main className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <p className="text-4xl font-black text-green-600 mb-1">Prevent overcharging</p>
        <p className="text-gray-500 mb-6">5 mins · Beginner · Prevents estimated billing</p>
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-gray-700 mb-2">Most homes have two meters: one for electricity and one for gas. Smart meters send readings automatically. If you have a traditional meter with a dial or number display, you need to read it yourself.</p>
        </div>
        ...
        <div className="bg-red-50 border border-red-200 rounded-xl p-6 mb-6">
          <h2 className="font-semibold text-red-800 mb-3">Stop and call a energy supplier if...</h2>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-blue-900">Once you are reading your meter regularly, you can track your energy use month by month and spot if consumption suddenly increases — which can indicate a faulty appliance or a problem with insulation.</p>
        </div>
