    ...
    <main className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-gray-700 mb-2">Test a small area first. Some wallpaper strips dry in one piece (vinyl-coated paper). Most paper-backed wallpaper needs soaking with water or a stripping solution.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3 text-sm">
              ...
              <span><span className="font-medium">Wallpaper scorer</span> — <span className="text-orange-600">buy: buy: £3–5 — scores the surface so water penetrates through vinyl-coated wallpaper</span></span>
            </li>
            <li className="flex items-start gap-3 text-sm">
              <span className="text-orange-500 font-bold mt-0.5 shrink-0">!</span>
              <span><span className="font-medium">Stripping solution</span> — <span className="text-orange-600">buy: buy: £4–8 — mix with warm water; warm water alone works for uncoated paper</span></span>
            </li>
            <li className="flex items-start gap-3 text-sm">
              <span className="text-orange-500 font-bold mt-0.5 shrink-0">!</span>
              <span><span className="font-medium">Broad scraper (4–6 inch)</span> — <span className="text-orange-600">buy: buy: £5–10 if you do not have one</span></span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-blue-900">With bare walls, you can now fill and sand any damage, then paint or re-paper to completely transform the space.</p>
        </div>
