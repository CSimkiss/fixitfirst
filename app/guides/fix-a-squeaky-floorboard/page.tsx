    ...
    <main className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-gray-700 mb-2">Always use a pipe and cable detector before drilling into a floor. Pipes and cables run under floors — particularly near bathrooms, kitchens, and walls.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3 text-sm">
              ...
              <span><span className="font-medium">50mm wood screws</span> — <span className="text-orange-600">buy: buy: £1–3 — countersinking screws are ideal</span></span>
            </li>
            <li className="flex items-start gap-3 text-sm">
              <span className="text-orange-500 font-bold mt-0.5 shrink-0">!</span>
              <span><span className="font-medium">Wood filler</span> — <span className="text-orange-600">buy: buy: £3–5 if the floor is visible and you want a neat finish</span></span>
            </li>
          </ul>
        </div>
