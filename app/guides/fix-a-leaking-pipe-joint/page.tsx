  ...
  return (
    <main className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <p className="text-gray-500 mb-6">30 mins · Beginner · Saves £60–120 vs a plumber</p>
    ...
    { icon: 'buy', name: 'Replacement olive if needed', hint: 'buy — take the old one to match', hintOrange: true },
        ...
        <p className="text-sm text-gray-400 text-center mb-3">✅ Completed by {GUIDE_META['fix-a-leaking-pipe-joint'].completedCount.toLocaleString()} people</p>
