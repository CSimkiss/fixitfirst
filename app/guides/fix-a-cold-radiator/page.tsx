    ...
    <main className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-gray-700 mb-2">This guide covers the two most common causes: trapped air (bleed it) and a stuck valve (open it). Both are simple fixes.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3 text-sm">
              ...
              <span><span className="font-medium">Flat-head screwdriver</span> — <span className="text-orange-600">buy: to adjust the lockshield valve cap if needed</span></span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-blue-900">You can now balance all the radiators in your home, repressurise the boiler, and understand how your whole central heating system works.</p>
        </div>
