      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4"><div className="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center font-bold shrink-0">3</div><div><h3 className="font-semibold mb-1">Apply masking tape</h3><p className="text-sm text-gray-600">Run masking tape along the top of the skirting boards, around window frames, door frames, and the ceiling line. Press the tape edge down firmly to prevent bleed-through.</p></div></div>
            <div className="flex gap-4"><div className="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center font-bold shrink-0">4</div><div><h3 className="font-semibold mb-1">Cut in around the edges</h3><p className="text-sm text-gray-600">Using your angled brush, paint a neat band about 5cm wide along all edges — ceiling line, corners, skirting boards, and around any fixtures. Do one wall at a time so the edges stay wet when you roll.</p></div></div>
            <div className="flex gap-4"><div className="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center font-bold shrink-0">5</div><div><h3 className="font-semibold mb-1">Roll the walls</h3><p className="text-sm text-gray-600">Load the roller and apply paint in a large W or M shape, then fill in the gaps without lifting the roller. Work in sections of about 1 square metre, blending into the cut-in edges while still wet. Two thin coats always beat one thick one.</p></div></div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-yellow-900">Leaving masking tape on too long — remove while the final coat is still slightly tacky to avoid peeling the new paint.</p>
        </div>
