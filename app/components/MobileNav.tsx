export default function MobileNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 flex md:hidden z-50">
      <a href="/" className="flex flex-col items-center gap-1 flex-1 py-3 text-gray-500 hover:text-orange-500 transition-colors">
      ...
      <a href="#" className="flex flex-col items-center gap-1 flex-1 py-3 text-gray-500 hover:text-orange-500 transition-colors">
        ...
        <span className="text-xs font-medium">Find a Pro</span>
      </a>
    </nav>
  )
}
